...
const WysiwygDeliveryBoy = ({ placeholder }) => {
  ...
  return (
    <div className="p-3 bg-gray-200">
      <h4 className="text-lg font-bold text-blue-900">Delivery Boy Privacy Policy and Terms& Conditions </h4>
...
export default WysiwygDeliveryBoy